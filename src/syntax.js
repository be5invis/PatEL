module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c63 = function(car, cdr, tail) {
        		return ['.list', car].concat(cdr.map(function(x){ return x[2] }))
        	},
        peg$c64 = "::",
        peg$c65 = { type: "literal", value: "::", description: "\"::\"" },
        peg$c66 = function(car, cdr) { return ['.conslist'].concat(car.slice(1), [cdr]) },
        peg$c67 = function(cdr) { return ['.conslist', cdr] },
        peg$c68 = function(begins, head, rear, ends) { return BeginsEndsWith(head.concat(rear), begins, ends) },
        peg$c69 = void 0,
        peg$c70 = function(head, rear) { 
        		var res = [head]
        		for(var j = 0; j < rear.length; j++){
        			res.push(rear[j][1])
        		};
        ...
        peg$c79 = function(heads, rear, ends) {
        ...
        peg$c91 = function(begins, head, rear, ends) { 
        		var res = [head]
        		for(var j = 0; j < rear.length; j++){
        			res.push(rear[j][1])
        		};
        ...
        peg$c93 = { type: "other", description: "Identifier" },
        peg$c94 = /^[_$@]/,
        ...
        peg$c105 = function(hexdigits) { return ['.quote', parseInt(hexdigits, 16)] },
        peg$c106 = /^[0-9]/,
        peg$c107 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c108 = /^[eE]/,
        peg$c109 = { type: "class", value: "[eE]", description: "[eE]" },
        peg$c110 = function(decimal) { return ['.quote', decimal - 0] },
        peg$c111 = { type: "other", description: "String Literal" },
        peg$c112 = function(inner) { return joinInterpolation(inner) },
        peg$c113 = function(inner) { return ['.quote', inner.join('')] },
        peg$c114 = /^[^"\\\r\n]/,
        peg$c115 = { type: "class", value: "[^\"\\\\\\r\\n]", description: "[^\"\\\\\\r\\n]" },
        peg$c116 = function(common) { return ['.quote', common] },
        peg$c117 = "\\u",
        peg$c118 = { type: "literal", value: "\\u", description: "\"\\\\u\"" },
        peg$c119 = /^[a-fA-F0-9]/,
        peg$c120 = { type: "class", value: "[a-fA-F0-9]", description: "[a-fA-F0-9]" },
        peg$c121 = function(digits) { 
        		return ['.quote', String.fromCharCode(parseInt(digits.join(''), 16))]
        	},
        peg$c122 = "\\",
        peg$c123 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c124 = function(g) { return g },
        peg$c125 = "\\=",
        peg$c126 = { type: "literal", value: "\\=", description: "\"\\\\=\"" },
        peg$c127 = function() { return ['.quote', ''] },
        peg$c128 = /^[^u\r\n]/,
        peg$c129 = { type: "class", value: "[^u\\r\\n]", description: "[^u\\r\\n]" },
        peg$c130 = function(which) {
        		switch(which) {
        			case('n'): return ['.quote', "\n"];
        ...
        peg$c136 = { type: "other", description: "Space Character" },
        peg$c137 = /^[\t\x0B\f \xA0\uFEFF]/,
        peg$c138 = { type: "class", value: "[\\t\\x0B\\f \\xA0\\uFEFF]", description: "[\\t\\x0B\\f \\xA0\\uFEFF]" },
        peg$c139 = { type: "other", description: "Line Terminator" },
        peg$c140 = "\r",
        ...
        peg$c148 = { type: "other", description: "Comment" },
        peg$c149 = "#",
        peg$c150 = { type: "literal", value: "#", description: "\"#\"" },
        peg$c151 = /^[^\r\n]/,
        peg$c152 = { type: "class", value: "[^\\r\\n]", description: "[^\\r\\n]" },
        peg$c153 = { type: "other", description: "Space Character or Newline" },
        peg$c154 = /^[\r\n\u2028\u2029]/,
