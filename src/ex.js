...
r0_deQuasiquote = function _r0_t4(r6_form, r6_level) {
    ...
    return _r6_t0 = r6_form, _r6_t0 instanceof Array && _r6_t0.length === 2 && '.unquote' === _r6_t0[0] ? ((void 0, r6_c = _r6_t0[1]), !r6_level ? r6_c : [
        '.list',
        [
            '.quote',
            '.unquote'
    ...
    ]) : _r6_t0 instanceof Array && _r6_t0.length === 3 && '.unquote' === _r6_t0[0] && (_r6_t0[2] instanceof Array && _r6_t0[2].length === 2 && '.quote' === _r6_t0[2][0]) ? ((void 0, r6_c = _r6_t0[1], (void 0, r6_decLevel = _r6_t0[2][1])), (r6_decLevel = Math.max(1, Math.floor(r6_decLevel)), r6_level - r6_decLevel < 0 ? r6_c : [
        '.list',
        [
            '.quote',
            '.unquote'
    ...
    ])) : _r6_t0 instanceof Array && _r6_t0.length === 2 && '.quasiquote' === _r6_t0[0] ? ((void 0, r6_c = _r6_t0[1]), [
        '.list',
        [
            '.quote',
            '.quasiquote'
        ...
        r0_deQuasiquote(r6_c, r6_level + 1)
    ]) : _r6_t0 instanceof Array && _r6_t0.length >= 0 ? (r6_xs = _r6_t0.slice(0), (_r6_t1 = r6_xs[r6_xs.length - 1], _r6_t1 instanceof Array && _r6_t1.length === 2 && '.sliceunquote' === _r6_t1[0] ? ((void 0, r6_x = _r6_t1[1]), (r6_commonParts = r6_xs.slice(0, 0 - 1).map(function _r6_t4(r8_c) {
...
r0_ex = r0_NodeTranslation(function _r0_t5(r9_form, r9_env) {
    ...
    _r9_t0 = r9_form;
    if (_r9_t0 instanceof Array && _r9_t0.length === 2 && '.preserve' === _r9_t0[0]) {
        r9_x = _r9_t0[1];
        return r9_x;
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 1 && '.quote' === _r9_t0[0]) {
        r9_x = _r9_t0.slice(1);
        return ['.quote'].concat(r9_x);
    } else if (_r9_t0 instanceof Array && _r9_t0.length === 2 && '.quasiquote' === _r9_t0[0])
        return (void 0, r9_x = _r9_t0[1]), r0_ex(r0_deQuasiquote(r9_x, 0), r9_env);
    else if (_r9_t0 instanceof Array && _r9_t0.length === 2 && '.unquote' === _r9_t0[0]) {
        r9_x = _r9_t0[1];
        return r0_ex(r9_x, r9_env);
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 1 && '.id' === _r9_t0[0]) {
        r9_x = _r9_t0.slice(1);
        return ['.id'].concat(r9_x);
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 1 && '.t' === _r9_t0[0]) {
        r9_x = _r9_t0.slice(1);
        return ['.t'].concat(r9_x);
    } else if (_r9_t0 instanceof Array && _r9_t0.length === 3 && '.lambda' === _r9_t0[0] && (_r9_t0[1] instanceof Array && _r9_t0[1].length >= 0)) {
    ...
    } else if (_r9_t0 instanceof Array && _r9_t0.length === 3 && '.syntactic-closure' === _r9_t0[0])
        return (void 0, r9_c = _r9_t0[1], r9_e = _r9_t0[2]), r0_ex(r9_c, r9_e);
    else if (_r9_t0 instanceof Array && _r9_t0.length >= 3 && '.beta' === _r9_t0[0] && (_r9_t0[1] instanceof Array && _r9_t0[1].length >= 0)) {
        r9_args = _r9_t0[1].slice(0);
        r9_body = _r9_t0[2];
    ...
    } else if (_r9_t0 instanceof Array && _r9_t0.length === 4 && '.try' === _r9_t0[0] && (_r9_t0[2] instanceof Array && _r9_t0[2].length === 1)) {
        r9_block = _r9_t0[1];
        r9_param = _r9_t0[2][0];
        r9_handler = _r9_t0[3];
    ...
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 1 && '.xhash' === _r9_t0[0]) {
        ...
        for (; r9_j < r9_form.length; r9_j = r9_j + 1) {
            ...
            _r9_t1 = r9_key;
            if (_r9_t1 instanceof Array && _r9_t1.length === 2 && '.quote' === _r9_t1[0]) {
                r9_x = _r9_t1[1];
            } else {
                r9_otherwise = _r9_t1;
    ...
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 1 && '.hash' === _r9_t0[0]) {
        r9_args = _r9_t0.slice(1);
        r9_a = [];
        r9_j = 1;
        for (; r9_j < r9_form.length; r9_j = r9_j + 1) {
    ...
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 1 && '.conslist' === _r9_t0[0]) {
    ...
    } else if (_r9_t0 instanceof Array && _r9_t0.length === 2 && '.local' === _r9_t0[0]) {
        r9_x = _r9_t0[1];
        r9_env.declare(r9_x);
        return r9_env.use(r9_x);
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 3 && '.revcall' === _r9_t0[0]) {
        r9_callee = _r9_t0[1];
        r9_arg0 = _r9_t0[2];
    ...
    } else if (_r9_t0 instanceof Array && _r9_t0.length >= 1) {
        r9_callee = _r9_t0[0];
        r9_args = _r9_t0.slice(1);
        if (r0_atom(r9_callee) && r9_env.macros.has(r9_callee) && r9_env.macros.get(r9_callee) instanceof Function)
        ...
        if (!r0_prim(r9_callee))
            _r9_t24 = r9_callee = r0_ex(r9_callee, r9_env);
        else
            _r9_t24 = void 0;
        r9_a = [r9_callee];
        r9_j = 1;
