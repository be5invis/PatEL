...
s1_Scope = require("patrisika").Scope, s1_atom = function(s2_x) {
    ...
    var s7_form, s7_env, s7_any, s7_x, s7_callee, s7_args, s7_a, s7_j, s7_allKeysAreQuotes, s7_key, s7_value, s7_otherwise, s7_block, s7_param, s7_handler, s7_body, s7_params, s7_derived, s7_c, s7_e, s7_r, _s7_t0, _s7_t1, _s7_t15, _s7_t16, _s7_t17, _s7_t22, _s7_t23;
    if (_s7_t17 = arguments, _s7_t16 = this, _s7_t0 = s7_form, _s7_t0 instanceof Array && _s7_t0.length >= 1 && ".quote" === _s7_t0[0]) return s7_x = _s7_t0.slice(1), 
    [ ".quote" ].concat(s7_x);
    if (_s7_t0 instanceof Array && 2 === _s7_t0.length && ".quasiquote" === _s7_t0[0]) return s7_x = _s7_t0[1], 
    (s7_r = function(s11_form) {
        var s11_form, s11_otherwise, s11_xs, s11_c, _s11_t0;
        return _s11_t0 = s11_form, _s11_t0 instanceof Array && 2 === _s11_t0.length && "unquote" === _s11_t0[0] ? (s11_c = _s11_t0[1], 
        s1_ex(s11_c, s7_env)) : _s11_t0 instanceof Array && 2 === _s11_t0.length && ".unquote" === _s11_t0[0] ? (s11_c = _s11_t0[1], 
        s1_ex(s11_c, s7_env)) : _s11_t0 instanceof Array && _s11_t0.length >= 0 ? (s11_xs = _s11_t0.slice(0), 
        [ ".list" ].concat(s11_xs.map(s7_r))) : (s11_otherwise = _s11_t0, [ ".quote", s11_otherwise ]);
    })(s7_x);
    if (_s7_t0 instanceof Array && 2 === _s7_t0.length && ".unquote" === _s7_t0[0]) return s7_x = _s7_t0[1], 
    s1_ex(s7_x, s7_env);
    ...
    if (_s7_t0 instanceof Array && _s7_t0.length >= 1 && ".hash" === _s7_t0[0]) {
        ...
        })) : (_s7_t15 = s7_env.newt(), function(s9_t) {
            var s9_t;
    ...
    if (_s7_t0 instanceof Array && _s7_t0.length >= 1) {
        ...
        for (_s7_t22 = void 0, _s7_t23 = s1_prim(s7_callee) ? void 0 : s7_callee = s1_ex(s7_callee, s7_env), 
