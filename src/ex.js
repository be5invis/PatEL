...
s1_Scope = require("patrisika").Scope, s1_atom = function(s2_x) {
    ...
    var s4_form, s4_env, s4_any, s4_x, s4_callee, s4_args, s4_a, s4_j, s4_block, s4_param, s4_handler, s4_body, s4_params, s4_derived, _s4_t0, _s4_t9, _s4_t10;
    ...
    if (_s4_t0 instanceof Array && _s4_t0.length >= 1) {
        ...
        for (_s4_t9 = void 0, _s4_t10 = s1_prim(s4_callee) ? void 0 : s4_callee = s1_ex(s4_callee, s4_env), 
