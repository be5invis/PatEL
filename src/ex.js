'use strict';
var _r1_t0, _r1_t1, _r1_t2, _r1_t3, _r1_t4, _r1_t5, _r1_t6, _r1_t7, _r1_leti8, _r1_t10, _r1_t11, _r1_t12, _r1_tag13;
...
var r1_trace = [];
var r1_findform = function (r127_form) {
    if (r127_form && r127_form.within && r127_form.begins >= 0 && r127_form.ends >= 0)
        return r127_form;
    var r127_j = r1_trace.length - 1;
    for (; r127_j >= 0; r127_j = r127_j - 1)
        if (r1_trace[r127_j] && r1_trace[r127_j].within && r1_trace[r127_j].begins >= 0 && r1_trace[r127_j].ends >= 0)
            return r1_trace[r127_j];
    return r127_form;
};
var _r1_t9 = require('patrisika').FormInvalidError;
var r1_FormInvalidError = function (_r1_leti8) {
    var r128_raw = _r1_leti8;
    return function (r129_form, r129_reason) {
        return new r128_raw(r1_findform(r129_form), r129_reason);
    };
}(_r1_t9);
...
var r1_ex = r1_NodeTranslation(function (r137_form, r137_env) {
    var r137_any, r137_x, r137_callee, r137_args, r137_a, r137_j, r137_arg0, r137_args1, r137_t, r137_constQ, r137_items, r137_allKeysAreQuotes, r137_key, r137_value, r137_block, r137_param, r137_handler, r137_body, r137_params, r137_c, r137_e, _r137_t1, _r137_t27, _r137_tag28, _r137_t30, _r137_tag31, _r137_t33;
...
exports.pass = function (r144_form, r144_globalScope) {
    return r1_ex(r144_form, r144_globalScope);
};
exports.ex = r1_ex;
exports.checkEvaluated = r1_checkEvaluated;
exports.deQuasiquote = r1_deQuasiquote;
exports.opSegToRegular = r1_opSegToRegular;
exports.FormInvalidError = r1_FormInvalidError;
