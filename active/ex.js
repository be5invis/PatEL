'use strict';
var _r1_leti0, _r1_t1, _r1_t2, _r1_t3, _r1_t4, _r1_t6, _r1_t7, _r1_t8, _r1_tag9, _r1_t10, _r1_t11, _r1_t12, _r1_t13, _r1_t14, _r1_t15, _r1_t16, r1_Scope = require('patrisika').Scope, r1_atom = function _r1_t1(r113_x) {
        return typeof r113_x === 'string';
    }, r1_identifier = function _r1_t2(r114_x) {
    ...
    }, r1_prim = function _r1_t3(r115_x) {
        return r1_atom(r115_x) && !r1_identifier(r115_x);
    }, r1_trace = [], r1_findform = function _r1_t4(r116_form) {
        ...
        return r116_form;
    }, _r1_t5 = require('patrisika').FormInvalidError, r1_FormInvalidError = function (_r1_leti0, r117_raw, _r117_t0) {
        return r117_raw = _r1_leti0, function _r117_t0(r118_form, r118_reason) {
            return new r117_raw(r1_findform(r118_form), r118_reason);
        };
    }(_r1_t5), r1_NodeTranslation = function _r1_t10(r119_fn) {
    ...
    }, r1_deQuasiquote = function _r1_t11(r121_form, r121_level, r121_env) {
        var r121_otherwise, r121_xs, r121_x, r121_commonParts, r121_items, r121_c, r121_decLevel, _r121_t0, _r121_t1;
    ...
    }, r1_opSegToRegular = function _r1_t13(r125_items, r125_env) {
